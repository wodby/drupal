...
backend default {
    ...
    .first_byte_timeout = {{ getenv "VARNISH_BACKEND_FIRST_BYTE_TIMEOUT" "300s" }};
    .connect_timeout = {{ getenv "VARNISH_BACKEND_CONNECT_TIMEOUT" "5s" }};
    .between_bytes_timeout = {{ getenv "VARNISH_BACKEND_BETWEEN_BYTES_TIMEOUT" "2s" }};
}

# Access control list for PURGE requests.
acl purge {
    {{ if getenv "VARNISH_ACL_PURGE" }}{{ getenv "VARNISH_ACL_PURGE" }};{{end}}
    "localhost";
    "127.0.0.1";
    "::1";
}
